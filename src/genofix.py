...
''' % (program_shortdesc, str(__date__))
    ...
    try:
        ...
        parser.add_argument("-l", "--thresholdsingles", dest="threshold_singles", type=float, default=0.64, help="threshold prob for singles")
        ...
        parser.add_argument("-t", "--tiethreshold", dest="tiethreshold", type=float, default=0.4,  help="error tolerance between probabilies to declare a tie")
        ...
        parser.add_argument("-q", "--initquantilefilter", dest="initquantilefilter", type=float, required=False, default=0.95,  help="initial filter to select upper quantile in error likelihood dist")
        parser.add_argument("-Q", "--filter_e", dest="filter_e", type=float, required=False, default=0.99,  help="filter to select upper quantile to exclude from empirical ld calculation")
        parser.add_argument("-W", "--weightempirical", dest="weight_empirical", type=float, required=False, default=1.9,  help="weight of empirical vs collected medelian error when ranking snps by error probability")
